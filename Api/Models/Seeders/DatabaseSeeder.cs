    ...
    public static class DatabaseSeeder
    {
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            var projects = new[]
            {
                ...
                new Projeto { Id = Guid.Parse("30303030-3030-4303-8303-303030303030"), IdCriador = Guid.Parse("33333333-3333-4333-8333-333333333333"), Criador = null!, Nome = "Projeto Gamma", Descricao = "Projeto Gamma - um exemplo estático.", MetaFinanceira = 2500m, TotalContribuicoes = 0, TotalArrecadado = 0m, DataCriacao = DateTime.UtcNow.AddMonths(-3), Status = Status.EncerradoPeloCriador },
                ...
                new Projeto { Id = Guid.Parse("70707070-7070-4707-8707-707070707070"), IdCriador = Guid.Parse("77777777-7777-4777-8777-777777777777"), Criador = null!, Nome = "Projeto Eta", Descricao = "Projeto Eta - um exemplo estático.", MetaFinanceira = 1500m, TotalContribuicoes = 0, TotalArrecadado = 0m, DataCriacao = DateTime.UtcNow.AddMonths(-7), Status = Status.EncerradoPeloCriador },
                ...
                new Projeto { Id = Guid.Parse("15151515-1515-4151-8151-151515151515"), IdCriador = Guid.Parse("aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa"), Criador = null!, Nome = "Projeto Upsilon", Descricao = "Projeto Upsilon - um exemplo estático.", MetaFinanceira = 9500m, TotalContribuicoes = 0, TotalArrecadado = 0m, DataCriacao = DateTime.UtcNow.AddMonths(-20), Status = Status.EncerradoPeloCriador },
                ...
                new Projeto { Id = Guid.Parse("17171717-1717-4171-8171-171717171717"), IdCriador = Guid.Parse("22222222-2222-4222-8222-222222222222"), Criador = null!, Nome = "Projeto Chi", Descricao = "Projeto Chi - um exemplo estático.", MetaFinanceira = 6800m, TotalContribuicoes = 0, TotalArrecadado = 0m, DataCriacao = DateTime.UtcNow.AddMonths(-22), Status = Status.EncerradoPeloCriador },
                ...
                new Projeto { Id = Guid.Parse("1b1b1b1b-1b1b-4b1b-8b1b-1b1b1b1b1b1b"), IdCriador = Guid.Parse("66666666-6666-4666-8666-666666666666"), Criador = null!, Nome = "Projeto Beacon", Descricao = "Projeto Beacon - um exemplo estático.", MetaFinanceira = 11000m, TotalContribuicoes = 0, TotalArrecadado = 0m, DataCriacao = DateTime.UtcNow.AddMonths(-26), Status = Status.EncerradoPeloCriador },
                ...
                new Projeto { Id = Guid.Parse("1d1d1d1d-1d1d-4d1d-8d1d-1d1d1d1d1d1d"), IdCriador = Guid.Parse("88888888-8888-4888-8888-888888888888"), Criador = null!, Nome = "Projeto Dynamo", Descricao = "Projeto Dynamo - um exemplo estático.", MetaFinanceira = 7800m, TotalContribuicoes = 0, TotalArrecadado = 0m, DataCriacao = DateTime.UtcNow.AddMonths(-28), Status = Status.EncerradoPeloCriador },
