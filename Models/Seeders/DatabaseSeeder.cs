    ...
    public static class DatabaseSeeder
    {
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            var projects = new[]
            {
                ...
                new Projeto { Id = Guid.Parse("30303030-3030-4303-8303-303030303030"), IdCriador = Guid.Parse("33333333-3333-4333-8333-333333333333"), Criador = null!, Nome = "Projeto Gamma", Descricao = "Projeto Gamma - um exemplo estático.", MetaFinanceira = 2500m, TotalContribuicoes = 0, TotalArrecadado = 0m, DataCriacao = DateTime.UtcNow.AddMonths(-3), Status = Status.Ativo },
                ...
                new Projeto { Id = Guid.Parse("70707070-7070-4707-8707-707070707070"), IdCriador = Guid.Parse("77777777-7777-4777-8777-777777777777"), Criador = null!, Nome = "Projeto Eta", Descricao = "Projeto Eta - um exemplo estático.", MetaFinanceira = 1500m, TotalContribuicoes = 0, TotalArrecadado = 0m, DataCriacao = DateTime.UtcNow.AddMonths(-7), Status = Status.Ativo },
            ...
            var contribs = new[]
            {
                ...
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-000000000004"), UserId = Guid.Parse("55555555-5555-4555-8555-555555555555"), ProjectId = Guid.Parse("40404040-4040-4404-8404-404040404040"), Valor = 75m, DataCriacao = DateTime.UtcNow.AddDays(-4) },
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-000000000005"), UserId = Guid.Parse("66666666-6666-4666-8666-666666666666"), ProjectId = Guid.Parse("50505050-5050-4505-8505-505050505050"), Valor = 25m, DataCriacao = DateTime.UtcNow.AddDays(-5) },
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-000000000006"), UserId = Guid.Parse("77777777-7777-4777-8777-777777777777"), ProjectId = Guid.Parse("50505050-5050-4505-8505-505050505050"), Valor = 50m, DataCriacao = DateTime.UtcNow.AddDays(-6) },
                ...
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-00000000000A"), UserId = Guid.Parse("11111111-1111-4111-8111-111111111111"), ProjectId = Guid.Parse("80808080-8080-4808-8808-808080808080"), Valor = 250m, DataCriacao = DateTime.UtcNow.AddDays(-10) },
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-00000000000B"), UserId = Guid.Parse("22222222-2222-4222-8222-222222222222"), ProjectId = Guid.Parse("a0a0a0a0-a0a0-4a0a-8a0a-a0a0a0a0a0a0"), Valor = 60m, DataCriacao = DateTime.UtcNow.AddDays(-11) },
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-00000000000C"), UserId = Guid.Parse("33333333-3333-4333-8333-333333333333"), ProjectId = Guid.Parse("b1b1b1b1-b1b1-4b1b-8b1b-b1b1b1b1b1b1"), Valor = 420m, DataCriacao = DateTime.UtcNow.AddDays(-12) },
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-00000000000D"), UserId = Guid.Parse("44444444-4444-4444-8444-444444444444"), ProjectId = Guid.Parse("c2c2c2c2-c2c2-4c2c-8c2c-c2c2c2c2c2c2"), Valor = 300m, DataCriacao = DateTime.UtcNow.AddDays(-13) },
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-00000000000E"), UserId = Guid.Parse("55555555-5555-4555-8555-555555555555"), ProjectId = Guid.Parse("c2c2c2c2-c2c2-4c2c-8c2c-c2c2c2c2c2c2"), Valor = 150m, DataCriacao = DateTime.UtcNow.AddDays(-14) },
                ...
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-000000000010"), UserId = Guid.Parse("77777777-7777-4777-8777-777777777777"), ProjectId = Guid.Parse("f5f5f5f5-f5f5-4f5f-8f5f-f5f5f5f5f5f5"), Valor = 100m, DataCriacao = DateTime.UtcNow.AddDays(-16) },
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-000000000011"), UserId = Guid.Parse("88888888-8888-4888-8888-888888888888"), ProjectId = Guid.Parse("f5f5f5f5-f5f5-4f5f-8f5f-f5f5f5f5f5f5"), Valor = 150m, DataCriacao = DateTime.UtcNow.AddDays(-17) },
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-000000000012"), UserId = Guid.Parse("99999999-9999-4999-8999-999999999999"), ProjectId = Guid.Parse("f5f5f5f5-f5f5-4f5f-8f5f-f5f5f5f5f5f5"), Valor = 250m, DataCriacao = DateTime.UtcNow.AddDays(-18) },
                new Contribuicao { Id = Guid.Parse("10000000-0000-4000-8000-000000000013"), UserId = Guid.Parse("aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa"), ProjectId = Guid.Parse("01010101-0101-4101-8101-010101010101"), Valor = 60m, DataCriacao = DateTime.UtcNow.AddDays(-19) },
